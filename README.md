...
├── js/
│   ├── data.js         # 20 questions + 50+ destinations data
│   └── app.js          # App logic, scoring, transitions
└── README.md
```
...
2. Mencocokkan skor tag ke 50+ destinasi
3. Menampilkan 6 destinasi dengan skor tertinggi
4. Menentukan tipe traveler dari 8 personality types
...
| Kategori | Contoh |
|----------|--------|
| 🌋 Gunung | Bromo, Rinjani, Ijen, Dieng, Kerinci |
| 🐠 Bahari | Raja Ampat, Labuan Bajo, Bunaken, Wakatobi |
| 🏛️ Budaya | Yogyakarta, Toraja, Ubud, Wae Rebo |
| 🌿 Alam | Komodo, Leuser, Tanjung Puting, Baluran |
| 🏙️ Kota | Jakarta, Bandung, Makassar, Manado |
| 💆 Resort | Ubud Retreat, Seminyak, Gili Islands |
